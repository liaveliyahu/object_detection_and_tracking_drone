...
class Brain:
    def __init__(self, err_dist=3, err_radius=10, track_distance=30, ref_object_width=315, ref_object_dist=30):
        self.drone = Drone()
    ...
    def act(self, img, x, y, h, w, image_weight, image_height):
        self.calc_image_center(image_weight, image_height)
    ...
    def calc_image_center(self, image_weight, image_height):
        image_center = (image_weight//2,image_height//2)
